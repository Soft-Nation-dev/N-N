/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 2f35fab4c14c670f6db6e34d8d579627)
// Runtime types generated with workerd@1.20260804.1 2026-08-11 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	ASSETS: Fetcher;
	ALLOWED_ORIGINS: "http://localhost:5173,https://soft-nation-dev.github.io,https://vanillalovestory.com.ng,https://www.vanillalovestory.com.ng";
	ADMIN_PASSWORD: string;
	RSVP_HASH_SALT: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_ORIGINS" | "ADMIN_PASSWORD" | "RSVP_HASH_SALT">> {}
}
